...
export default function TheDichotomy() {
  ...
  useLayoutEffect(() => {
    ...
    return () => tl.kill();
  }, [desc, isRational]); // eslint-disable-line react-hooks/exhaustive-deps
